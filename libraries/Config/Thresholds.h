...
#define MOTOR_LEFT_FORWARD_LEFT_BEND_SPEED		0		//  Left wall follow
#define MOTOR_RIGHT_FORWARD_LEFT_BEND_SPEED		0
...
#define GOAL_LEFT_OFFSET			30
#define GOAL_RIGHT_OFFSET			-30
