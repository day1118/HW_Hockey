...
#define MOTOR_LEFT_FORWARD_LEFT_BEND_SPEED		0
#define MOTOR_RIGHT_FORWARD_LEFT_BEND_SPEED		MOTOR_LEFT_FORWARD_LEFT_BEND_SPEED
#define MOTOR_LEFT_FORWARD_RIGHT_BEND_SPEED		MOTOR_LEFT_FORWARD_LEFT_BEND_SPEED
